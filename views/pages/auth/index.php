<section class="d-flex flex-column justify-center-center align-items-center">
    ...
    <form class="row g-3 needs-validation mt-5 register-form" style="max-width: 600px;" novalidate>
        <h4 class="text-center mb-3">Register Account</h4>

        <div class="col-md-6"> <label class="form-label">First Name</label> <input type="text" class="form-control" name="firstName" required>
        ...
        <div class="col-12">
            <button class="btn btn-primary w-100 submit-register" type="submit">Register</button>
        </div>

    </form>

    <form class="row g-3 needs-validation mt-5 login-form d-none" style="max-width: 600px;" novalidate>
        ...
        <div class="col-12">
            <button class="btn btn-primary w-100 submit-login" type="submit">Log In</button>
        </div>
    </form>
</section>